...
/**
 * This is the model class for table "t_dict_tag_word".
 *
 ...
 */
class DictTagWord extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return DictTagWord the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			 'dword' => array(self::BELONGS_TO, 'DictWord', 'word'),
		);
	}
